    ...
    return (
        <div className={"App-page"}>
            ...
            <div className={"App-img-container"}>
                <video autoPlay={true} loop={true} className={"App-img"} src={process.env.PUBLIC_URL + "/bc-jellyfish.mp4"} />
            </div>
            <p>I created the front end using React, with Redux and CSSTransitions, using Django Rest Framework in the backend.</p>
            <div className={"App-img-container"}>
                <video autoPlay={true} loop={true} className={"App-img"} src={process.env.PUBLIC_URL + "/bc-all-directions.mp4"} />
            </div>
            <p>They music player changes the level.</p>
            <div className={"App-img-container"}>
                <video autoPlay={true} loop={true} className={"App-img"} src={process.env.PUBLIC_URL + "/bc-music-player.mp4"} />
            </div>
            ...
            <div className={"App-img-container"}>
                <video autoPlay={true} loop={true} className={"App-img"} src={process.env.PUBLIC_URL + "/bc-build-scale.mp4"} />
            </div>
            <p>Elements can also be translated.</p>
            <div className={"App-img-container"}>
                <video autoPlay={true} loop={true} className={"App-img"} src={process.env.PUBLIC_URL + "/bc-build-translate.mp4"} />
            </div>
            <p>Now the blue guy disappears on click, but the coin does not.</p>
            <div className={"App-img-container"}>
                <video autoPlay={true} loop={true} className={"App-img"} src={process.env.PUBLIC_URL + "/bc-build-scale-result.mp4"} />
            </div>
            <p>That's because translate moves elements without moving their clickable area. So does scale.</p>
            <div className={"App-img-container"}>
                <video autoPlay={true} loop={true} className={"App-img"} src={process.env.PUBLIC_URL + "/bc-build-translate-result.mp4"} />
            </div>
            <br/>
        </div>
    )
