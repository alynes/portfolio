    ...
    return (
        <div className={"App-page"}>
            ...
            <div className={"App-img-container"}>
                <video autoPlay muted loop className={"App-img"} src={process.env.PUBLIC_URL + "/sa-login.mp4"} />
            </div>
            <p>
            ...
            <div className={"App-img-container"}>
                <video autoPlay muted loop className={"App-img"} src={process.env.PUBLIC_URL + "/sa-oauth2.mp4"} />
            </div>
            <p>
            ...
            <div className={"App-img-container"}>
                <video autoPlay muted loop className={"App-img"} src={process.env.PUBLIC_URL + "/sa-task-create.mp4"} />
            </div>
            <p>
                Those tasks are grouped into a weekly schedule and users actions are batched together by a worker service.
            </p>
            <div className={"App-img-container"}>
                <video autoPlay muted loop className={"App-img"} src={process.env.PUBLIC_URL + "/sa-schedule.mp4"} />
            </div>
        </div>
    )
}
