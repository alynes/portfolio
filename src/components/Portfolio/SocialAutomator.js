    ...
    return (
        <div className={"App-page"}>
            ...
            <div className={"App-img-container"}>
                <video autoPlay={true} loop={true} className={"App-img"} src={process.env.PUBLIC_URL + "/sa-response-edit.mp4"} />
            </div>
            <p>
            ...
            <div className={"App-img-container"}>
                <video autoPlay={true} loop={true} className={"App-img"} src={process.env.PUBLIC_URL + "/sa-who-r-u.mp4"} />
            </div>
            <p>
                If it cannot find the pattern in the test text, it will not respond.
            </p>
            <div className={"App-img-container"}>
                <video autoPlay={true} loop={true} className={"App-img"} src={process.env.PUBLIC_URL + "/sa-not-found.mp4"} />
            </div>
            <p>
